...
class Dicts(object):
    ...
    def lookup(self, key, default=None):
        try:
            ...
            return default
     #extra func       
    def lookups(self, key, default=None):
        try:
            return self.labelToIdx[key[0]]
        except KeyError:
            return default            
    ...
    ##Extra added func    
    def convertToIdxs(self, labels, unkWord, bosWord=None, eosWord=None):
        vec = []
    ...
    def convertToLabels(self, idx, stop):
        ...
        return labels
    #extra    
    def convertToLabelss(self, idx, stop=None):
        labels = []
